...
class Chart extends React.Component {
	...
	updateComparisonSeries(args) {
		let stx = args.stx;
		if (window.FSBL && window.saveLayout) window.saveLayout({ stx: stx });
		if (args.action == 'remove-series') {
			this.props.removeComparisonAndSave(args.symbol)
		}
  }
	render() {
		return (
